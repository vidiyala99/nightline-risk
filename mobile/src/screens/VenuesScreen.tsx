...
const styles = StyleSheet.create({
  ...
  addBtnText: { color: Colors.accentInk, fontSize: 11, fontWeight: '700', letterSpacing: 1.5, fontFamily: 'SpaceMono_700Bold' },
  ...
  primaryBadge: { color: Colors.accentInk, fontSize: 9, fontWeight: '700', letterSpacing: 2, fontFamily: 'SpaceMono_700Bold' },
  venueName: { color: Colors.text, fontSize: 20, fontWeight: '700', letterSpacing: -0.5, fontFamily: 'BricolageGrotesque_700Bold' },
  venueId: { color: Colors.border, fontSize: 10, fontFamily: 'SpaceMono_400Regular' },
  ...
  editBtnText: { color: Colors.textSecondary, fontSize: 10, fontWeight: '700', letterSpacing: 1.5, fontFamily: 'SpaceMono_700Bold' },

  detailGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  detailItem: { flex: 1, minWidth: '40%', gap: 2 },
  detailLabel: { color: Colors.textMuted, fontSize: 9, fontWeight: '700', letterSpacing: 2, fontFamily: 'SpaceMono_700Bold' },
  detailValue: { color: Colors.text, fontSize: 14, fontFamily: 'HankenGrotesk_400Regular' },

  editForm: { gap: 14 },
  editRow: { flexDirection: 'row', gap: 12 },
  inputWrap: { gap: 6 },
  label: { color: Colors.textMuted, fontSize: 10, fontWeight: '700', letterSpacing: 2, fontFamily: 'SpaceMono_700Bold' },
  input: {
  ...
  cancelBtnText: { color: Colors.textMuted, fontSize: 12, fontWeight: '700', letterSpacing: 1, fontFamily: 'SpaceMono_700Bold' },
  saveBtn: { flex: 2, backgroundColor: Colors.accent, borderRadius: 10, paddingVertical: 14, alignItems: 'center' },
  saveBtnText: { color: Colors.text, fontSize: 12, fontWeight: '800', letterSpacing: 1.5, fontFamily: 'HankenGrotesk_700Bold' },
  ...
  emptyHeading: { color: Colors.text, fontSize: 18, fontWeight: '700', fontFamily: 'BricolageGrotesque_700Bold' },
  emptyBody: { color: Colors.textMuted, fontSize: 13, fontFamily: 'HankenGrotesk_400Regular' },
});
