  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.header}>
        ...
        <HandAccent>{isBroker ? 'file or pass?' : 'worth filing?'}</HandAccent>
...
const s = StyleSheet.create({
  ...
  subtitle: { color: Colors.textMuted, fontSize: 12, fontFamily: 'SpaceMono_400Regular', marginTop: 4 },
  ...
  chipText: { color: Colors.textMuted, fontSize: 12, fontFamily: 'HankenGrotesk_600SemiBold' },
  chipTextActive: { color: Colors.accentInk },
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 12 },
  emptyIcon: { fontSize: 36 },
  emptyText: { color: Colors.textMuted, fontSize: 14, fontFamily: 'HankenGrotesk_400Regular', textAlign: 'center', paddingHorizontal: 40 },
  ...
  venueName: { color: Colors.text, fontSize: 14, fontFamily: 'HankenGrotesk_600SemiBold', textTransform: 'capitalize' },
  date: { color: Colors.textMuted, fontSize: 11, fontFamily: 'SpaceMono_400Regular' },
  overrideTag: { color: Colors.warning, fontSize: 10, fontFamily: 'SpaceMono_700Bold', letterSpacing: 0.5 },
  rowRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  stateBadge: { borderWidth: 1, borderRadius: 4, paddingHorizontal: 8, paddingVertical: 3 },
  stateText: { fontSize: 9, fontFamily: 'SpaceMono_700Bold', letterSpacing: 1, textTransform: 'uppercase' },
