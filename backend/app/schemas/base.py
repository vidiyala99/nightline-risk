...
class BaseEvent(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="When the event occurred at the source")
    received_at: datetime = Field(default_factory=datetime.utcnow, description="When the event hit our ingestion API")
