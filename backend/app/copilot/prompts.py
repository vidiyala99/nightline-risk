...
SYSTEM_PROMPT = (
    ...
    "3. Answer in ONE or TWO short, plain sentences for a busy operator mid-shift. State "
    "the number or status directly. Do not pad, list raw record IDs, or give advice the "
